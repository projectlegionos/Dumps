...
, ALL_SERVICE_IDX_TABLE as (
    ...
    group by service_name, service_proc_name, caller_uid_name, caller_proc_name, caller_thread_name, screen_mode, ground_mode, caller_calltimes
)
...
, SERVICE_CALLER_MERGED_ONECOLUME_TABLE as (
    ...
    || '"cun":' || group_concat(obfuscate(caller_uid_names)) || ','
